import unittest
from algorithm.semantic_learning_machine.neural_network import Sensor, Neuron
from algorithm.semantic_learning_machine.neural_network.connection import Connection
