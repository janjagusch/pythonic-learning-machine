...
from algorithms.semantic_learning_machine.neural_network.neural_network import create_neuron
...
class Mutation(object):
    ...
    def mutate_network(self, solution):
        pass
...
class Mutation1(Mutation):
    ...
    def mutate_network(self, solution):
        neural_network = solution.neural_network
...
class Mutation2(Mutation):
    ...
    def mutate_network(self, solution):
        neural_network = solution.current_champion.neural_network
        bias = neural_network.bias
