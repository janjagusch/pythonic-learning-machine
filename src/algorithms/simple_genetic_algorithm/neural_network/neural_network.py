...
from algorithms.simple_genetic_algorithm.neural_network.node import Neuron, Sensor
from algorithms.simple_genetic_algorithm.neural_network.activation_function import _ACTIVATION_FUNCTIONS
from algorithms.simple_genetic_algorithm.neural_network.connection import Connection
...
class NeuralNetwork(object):
    ...
    def __deepcopy__(self, memodict={}):
        ...
        memodict[id(bias)] = bias
        # Sensors can be referenced.
        sensors = self.sensors
        # Add sensors to memodict.
        if sensors:
            for sensor in sensors:
                memodict[id(sensor)] = sensor
        ...
        # Return deepcopy of neural network.
